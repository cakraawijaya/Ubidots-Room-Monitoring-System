...
| Komponen Lainnya| • Kabel USB Mikro - USB tipe A (x1)<br>• Papan ekspansi ESP32 (x1)<br>• Breadboard (x1)<br>• Adaptor DC 9V 1A (x1)<br>• Resistor 220 ohm (x1)<br>• Kabel jumper (1 set)<br>• PCB Dot Matrix Single Layer (x1)<br>• Terminal PCB block screw (x2)<br>• Box Proyek X5 (x1)<br>• Sekrup (x4)<br>• Baut M3 x 12 (x14)<br>• Baut M3 x 20 (x2)<br>• Baut M3 x 25 (x2)<br>• Baut M4 x 10 (x2)<br>• Mur M3 (x20)<br>• Mur M4 (x2) |
